...
<p align="center"> current fandoms/[fixations]: [yin's birthday bash: reimagined], [RIBBIT (deltarune mod)] and roblox bear alpha (this list is incredibly short because im not active in many fandoms, these are only the ones im active in as of now) . a lot of my interests are casual (i dont invest in it often), so dont take it to heart! <p>
